...
const Howwedo = () => {
  return (
    <section className="home__howwedo--body">
      <div className="home__howwedo container__padding">
        <div className="home__howwedo--left">
          <div className="howwedo-content">
            ...
            >
              ...
              <div className="howwedo-content--desc">
                Hire a full-time team that deserves your trust with the best
                rate in Asia.
              </div>
            </div>
          </div>
          <div className="howwedo-content">
            ...
            >
              ...
              <div className="howwedo-content--desc">
                Recruit your hourly-paid team and streamline through your
                product milestones.
              </div>
            </div>
          </div>
          <div className="howwedo-content">
            ...
            >
              ...
              <div className="howwedo-content--desc">
                Regardless of the time and expense, your budget is fixed with
                us.
              </div>
            </div>
          </div>
